...
draw_data_scale_clip_rects     :: #force_inline proc(self: ^Draw_Data, fb_scale: linalg.Vector2f32) do ImDrawData_ScaleClipRects(self, fb_scale);
...
draw_list_add_bezier_cubic               :: #force_inline proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, p4: linalg.Vector2f32, col: u32, thickness: f32, num_segments := i32(0))                                               do ImDrawList_AddBezierCubic(self, p1, p2, p3, p4, col, thickness, num_segments);
draw_list_add_bezier_quadratic           :: #force_inline proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, col: u32, thickness: f32, num_segments := i32(0))                                                         do ImDrawList_AddBezierQuadratic(self, p1, p2, p3, col, thickness, num_segments);
...
draw_list_add_circle                     :: #force_inline proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, col: u32, num_segments := i32(0), thickness := f32(1.0))                                                     do ImDrawList_AddCircle(self, center, radius, col, num_segments, thickness);
draw_list_add_circle_filled              :: #force_inline proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, col: u32, num_segments := i32(0))                                                                            do ImDrawList_AddCircleFilled(self, center, radius, col, num_segments);
draw_list_add_convex_poly_filled         :: #force_inline proc(self: ^Draw_List, points: ^linalg.Vector2f32, num_points: i32, col: u32)                                                                                               do ImDrawList_AddConvexPolyFilled(self, points, num_points, col);
draw_list_add_draw_cmd                   :: #force_inline proc(self: ^Draw_List)                                                                                                                                         do ImDrawList_AddDrawCmd(self);
draw_list_add_image                      :: #force_inline proc(self: ^Draw_List, user_texture_id: Texture_ID, p_min: linalg.Vector2f32, p_max: linalg.Vector2f32, uv_min := linalg.Vector2f32(linalg.Vector2f32 {0,0}), uv_max := linalg.Vector2f32(linalg.Vector2f32 {1,1}), col := u32(4294967295))  do ImDrawList_AddImage(self, user_texture_id, p_min, p_max, uv_min, uv_max, col);
draw_list_add_image_quad                 :: #force_inline proc(self: ^Draw_List, user_texture_id: Texture_ID, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, p4: linalg.Vector2f32, uv1 := linalg.Vector2f32(linalg.Vector2f32 {0,0}), uv2 := linalg.Vector2f32(linalg.Vector2f32 {1,0}), uv3 := linalg.Vector2f32(linalg.Vector2f32 {1,1}), uv4 := linalg.Vector2f32(linalg.Vector2f32 {0,1}), col := u32(4294967295)) do ImDrawList_AddImageQuad(self, user_texture_id, p1, p2, p3, p4, uv1, uv2, uv3, uv4, col);
draw_list_add_image_rounded              :: #force_inline proc(self: ^Draw_List, user_texture_id: Texture_ID, p_min: linalg.Vector2f32, p_max: linalg.Vector2f32, uv_min: linalg.Vector2f32, uv_max: linalg.Vector2f32, col: u32, rounding: f32, flags := Draw_Flags(0))     do ImDrawList_AddImageRounded(self, user_texture_id, p_min, p_max, uv_min, uv_max, col, rounding, flags);
draw_list_add_line                       :: #force_inline proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, col: u32, thickness := f32(1.0))                                                                                    do ImDrawList_AddLine(self, p1, p2, col, thickness);
draw_list_add_ngon                       :: #force_inline proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, col: u32, num_segments: i32, thickness := f32(1.0))                                                          do ImDrawList_AddNgon(self, center, radius, col, num_segments, thickness);
draw_list_add_ngon_filled                :: #force_inline proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, col: u32, num_segments: i32)                                                                                 do ImDrawList_AddNgonFilled(self, center, radius, col, num_segments);
draw_list_add_polyline                   :: #force_inline proc(self: ^Draw_List, points: ^linalg.Vector2f32, num_points: i32, col: u32, flags: Draw_Flags, thickness: f32)                                                            do ImDrawList_AddPolyline(self, points, num_points, col, flags, thickness);
draw_list_add_quad                       :: #force_inline proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, p4: linalg.Vector2f32, col: u32, thickness := f32(1.0))                                                                do ImDrawList_AddQuad(self, p1, p2, p3, p4, col, thickness);
draw_list_add_quad_filled                :: #force_inline proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, p4: linalg.Vector2f32, col: u32)                                                                                       do ImDrawList_AddQuadFilled(self, p1, p2, p3, p4, col);
draw_list_add_rect                       :: #force_inline proc(self: ^Draw_List, p_min: linalg.Vector2f32, p_max: linalg.Vector2f32, col: u32, rounding := f32(0.0), flags := Draw_Flags(0), thickness := f32(1.0))                                do ImDrawList_AddRect(self, p_min, p_max, col, rounding, flags, thickness);
draw_list_add_rect_filled                :: #force_inline proc(self: ^Draw_List, p_min: linalg.Vector2f32, p_max: linalg.Vector2f32, col: u32, rounding := f32(0.0), flags := Draw_Flags(0))                                                       do ImDrawList_AddRectFilled(self, p_min, p_max, col, rounding, flags);
draw_list_add_rect_filled_multi_color    :: #force_inline proc(self: ^Draw_List, p_min: linalg.Vector2f32, p_max: linalg.Vector2f32, col_upr_left: u32, col_upr_right: u32, col_bot_right: u32, col_bot_left: u32)                                 do ImDrawList_AddRectFilledMultiColor(self, p_min, p_max, col_upr_left, col_upr_right, col_bot_right, col_bot_left);

add_text :: proc {
	draw_list_add_text_vec2,
	draw_list_add_text_font_ptr,
};
draw_list_add_text_vec2                  :: #force_inline proc(self: ^Draw_List, pos: linalg.Vector2f32, col: u32, text_begin: string, text_end := "")                                                                                do swr_ImDrawList_AddText_Vec2(self, pos, col, text_begin, text_end);
draw_list_add_text_font_ptr              :: #force_inline proc(self: ^Draw_List, font: ^ImFont, font_size: f32, pos: linalg.Vector2f32, col: u32, text_begin: string, text_end := "", wrap_width := f32(0.0), cpu_fine_clip_rect : ^Vec4 = nil) do swr_ImDrawList_AddText_FontPtr(self, font, font_size, pos, col, text_begin, text_end, wrap_width, cpu_fine_clip_rect);

draw_list_add_triangle                   :: #force_inline proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, col: u32, thickness := f32(1.0))                                                                          do ImDrawList_AddTriangle(self, p1, p2, p3, col, thickness);
draw_list_add_triangle_filled            :: #force_inline proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, col: u32)                                                                                                 do ImDrawList_AddTriangleFilled(self, p1, p2, p3, col);
...
draw_list_get_clip_rect_max              :: #force_inline proc(pOut: ^linalg.Vector2f32, self: ^Draw_List)                                                                                                                            do ImDrawList_GetClipRectMax(pOut, self);
draw_list_get_clip_rect_min              :: #force_inline proc(pOut: ^linalg.Vector2f32, self: ^Draw_List)                                                                                                                            do ImDrawList_GetClipRectMin(pOut, self);
draw_list_path_arc_to                    :: #force_inline proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, a_min: f32, a_max: f32, num_segments := i32(0))                                                              do ImDrawList_PathArcTo(self, center, radius, a_min, a_max, num_segments);
draw_list_path_arc_to_fast               :: #force_inline proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, a_min_of_12: i32, a_max_of_12: i32)                                                                          do ImDrawList_PathArcToFast(self, center, radius, a_min_of_12, a_max_of_12);
draw_list_path_bezier_cubic_curve_to     :: #force_inline proc(self: ^Draw_List, p2: linalg.Vector2f32, p3: linalg.Vector2f32, p4: linalg.Vector2f32, num_segments := i32(0))                                                                                   do ImDrawList_PathBezierCubicCurveTo(self, p2, p3, p4, num_segments);
draw_list_path_bezier_quadratic_curve_to :: #force_inline proc(self: ^Draw_List, p2: linalg.Vector2f32, p3: linalg.Vector2f32, num_segments := i32(0))                                                                                             do ImDrawList_PathBezierQuadraticCurveTo(self, p2, p3, num_segments);
...
draw_list_path_line_to                   :: #force_inline proc(self: ^Draw_List, pos: linalg.Vector2f32)                                                                                                                              do ImDrawList_PathLineTo(self, pos);
draw_list_path_line_to_merge_duplicate   :: #force_inline proc(self: ^Draw_List, pos: linalg.Vector2f32)                                                                                                                              do ImDrawList_PathLineToMergeDuplicate(self, pos);
draw_list_path_rect                      :: #force_inline proc(self: ^Draw_List, rect_min: linalg.Vector2f32, rect_max: linalg.Vector2f32, rounding := f32(0.0), flags := Draw_Flags(0))                                                           do ImDrawList_PathRect(self, rect_min, rect_max, rounding, flags);
...
draw_list_prim_quad_uv                   :: #force_inline proc(self: ^Draw_List, a: linalg.Vector2f32, b: linalg.Vector2f32, c: linalg.Vector2f32, d: linalg.Vector2f32, uv_a: linalg.Vector2f32, uv_b: linalg.Vector2f32, uv_c: linalg.Vector2f32, uv_d: linalg.Vector2f32, col: u32)                                           do ImDrawList_PrimQuadUV(self, a, b, c, d, uv_a, uv_b, uv_c, uv_d, col);
draw_list_prim_rect                      :: #force_inline proc(self: ^Draw_List, a: linalg.Vector2f32, b: linalg.Vector2f32, col: u32)                                                                                                             do ImDrawList_PrimRect(self, a, b, col);
draw_list_prim_rect_uv                   :: #force_inline proc(self: ^Draw_List, a: linalg.Vector2f32, b: linalg.Vector2f32, uv_a: linalg.Vector2f32, uv_b: linalg.Vector2f32, col: u32)                                                                                     do ImDrawList_PrimRectUV(self, a, b, uv_a, uv_b, col);
...
draw_list_prim_vtx                       :: #force_inline proc(self: ^Draw_List, pos: linalg.Vector2f32, uv: linalg.Vector2f32, col: u32)                                                                                                          do ImDrawList_PrimVtx(self, pos, uv, col);
draw_list_prim_write_idx                 :: #force_inline proc(self: ^Draw_List, idx: Draw_Idx)                                                                                                                          do ImDrawList_PrimWriteIdx(self, idx);
draw_list_prim_write_vtx                 :: #force_inline proc(self: ^Draw_List, pos: linalg.Vector2f32, uv: linalg.Vector2f32, col: u32)                                                                                                          do ImDrawList_PrimWriteVtx(self, pos, uv, col);
draw_list_push_clip_rect                 :: #force_inline proc(self: ^Draw_List, clip_rect_min: linalg.Vector2f32, clip_rect_max: linalg.Vector2f32, intersect_with_current_clip_rect := bool(false))                                              do ImDrawList_PushClipRect(self, clip_rect_min, clip_rect_max, intersect_with_current_clip_rect);
...
draw_list_path_arc_to_fast_ex            :: #force_inline proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, a_min_sample: i32, a_max_sample: i32, a_step: i32)                                                           do ImDrawList__PathArcToFastEx(self, center, radius, a_min_sample, a_max_sample, a_step);
draw_list_path_arc_to_n                  :: #force_inline proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, a_min: f32, a_max: f32, num_segments: i32)                                                                   do ImDrawList__PathArcToN(self, center, radius, a_min, a_max, num_segments);
...
font_atlas_add_custom_rect_font_glyph                 :: #force_inline proc(self: ^Font_Atlas, font: ^ImFont, id: Wchar, width: i32, height: i32, advance_x: f32, offset := linalg.Vector2f32(linalg.Vector2f32 {0,0})) -> i32                               do return ImFontAtlas_AddCustomRectFontGlyph(self, font, id, width, height, advance_x, offset);
...
font_atlas_calc_custom_rect_uv                        :: #force_inline proc(self: ^Font_Atlas, rect: ^Font_Atlas_Custom_Rect, out_uv_min: ^linalg.Vector2f32, out_uv_max: ^linalg.Vector2f32)                                                                do ImFontAtlas_CalcCustomRectUV(self, rect, out_uv_min, out_uv_max);
...
font_atlas_get_mouse_cursor_tex_data                  :: #force_inline proc(self: ^Font_Atlas, cursor: Mouse_Cursor, out_offset: ^linalg.Vector2f32, out_size: ^linalg.Vector2f32, out_uv_border: [2]linalg.Vector2f32, out_uv_fill: [2]linalg.Vector2f32) -> bool                     do return ImFontAtlas_GetMouseCursorTexData(self, cursor, out_offset, out_size, out_uv_border, out_uv_fill);
...
font_calc_text_size_a          :: #force_inline proc(pOut: ^linalg.Vector2f32, self: ^ImFont, size: f32, max_width: f32, wrap_width: f32, text_begin: string, text_end := "", remaining : ^cstring = nil)                              do swr_ImFont_CalcTextSizeA(pOut, self, size, max_width, wrap_width, text_begin, text_end, remaining);
...
font_render_char               :: #force_inline proc(self: ^ImFont, draw_list: ^Draw_List, size: f32, pos: linalg.Vector2f32, col: u32, c: Wchar)                                                                                      do ImFont_RenderChar(self, draw_list, size, pos, col, c);
font_render_text               :: #force_inline proc(self: ^ImFont, draw_list: ^Draw_List, size: f32, pos: linalg.Vector2f32, col: u32, clip_rect: Vec4, text_begin: string, text_end: string, wrap_width := f32(0.0), cpu_fine_clip := bool(false)) do swr_ImFont_RenderText(self, draw_list, size, pos, col, clip_rect, text_begin, text_end, wrap_width, cpu_fine_clip);
...
viewport_get_center      :: #force_inline proc(pOut: ^linalg.Vector2f32, self: ^Viewport) do ImGuiViewport_GetCenter(pOut, self);
viewport_get_work_center :: #force_inline proc(pOut: ^linalg.Vector2f32, self: ^Viewport) do ImGuiViewport_GetWorkCenter(pOut, self);
...
begin_child_str                        :: #force_inline proc(str_id: string, size := linalg.Vector2f32(linalg.Vector2f32 {0,0}), border := bool(false), flags := Window_Flags(0)) -> bool                                                                     do return swr_igBeginChild_Str(str_id, size, border, flags);
begin_child_id                         :: #force_inline proc(id: ImID, size := linalg.Vector2f32(linalg.Vector2f32 {0,0}), border := bool(false), flags := Window_Flags(0)) -> bool                                                                           do return igBeginChild_ID(id, size, border, flags);

begin_child_frame                      :: #force_inline proc(id: ImID, size: linalg.Vector2f32, flags := Window_Flags(0)) -> bool                                                                                                                do return igBeginChildFrame(id, size, flags);
...
begin_list_box                         :: #force_inline proc(label: string, size := linalg.Vector2f32(linalg.Vector2f32 {0,0})) -> bool                                                                                                                       do return swr_igBeginListBox(label, size);
...
begin_table                            :: #force_inline proc(str_id: string, column: i32, flags := Table_Flags(0), outer_size := linalg.Vector2f32(linalg.Vector2f32 {0.0,0.0}), inner_width := f32(0.0)) -> bool                                             do return swr_igBeginTable(str_id, column, flags, outer_size, inner_width);
...
button                                 :: #force_inline proc(label: string, size := linalg.Vector2f32(linalg.Vector2f32 {0,0})) -> bool                                                                                                                       do return swr_igButton(label, size);
...
calc_text_size                         :: #force_inline proc(pOut: ^linalg.Vector2f32, text: string, text_end := "", hide_text_after_double_hash := bool(false), wrap_width := f32(-1.0))                                                        do swr_igCalcTextSize(pOut, text, text_end, hide_text_after_double_hash, wrap_width);
...
color_button                           :: #force_inline proc(desc_id: string, col: Vec4, flags := Color_Edit_Flags(0), size := linalg.Vector2f32(linalg.Vector2f32 {0,0})) -> bool                                                                            do return swr_igColorButton(desc_id, col, flags, size);
...
color_edit3                            :: #force_inline proc(label: string, col: [3]f32, flags := Color_Edit_Flags(0)) -> bool                                                                                                      do return swr_igColorEdit3(label, col, flags);
color_edit4                            :: #force_inline proc(label: string, col: [4]f32, flags := Color_Edit_Flags(0)) -> bool                                                                                                      do return swr_igColorEdit4(label, col, flags);
color_picker3                          :: #force_inline proc(label: string, col: [3]f32, flags := Color_Edit_Flags(0)) -> bool                                                                                                      do return swr_igColorPicker3(label, col, flags);
color_picker4                          :: #force_inline proc(label: string, col: [4]f32, flags := Color_Edit_Flags(0), ref_col : ^f32 = nil) -> bool                                                                                do return swr_igColorPicker4(label, col, flags, ref_col);
...
drag_float2                            :: #force_inline proc(label: string, v: [2]f32, v_speed := f32(1.0), v_min := f32(0.0), v_max := f32(0.0), format := "%.3f", flags := Slider_Flags(0)) -> bool                               do return swr_igDragFloat2(label, v, v_speed, v_min, v_max, format, flags);
drag_float3                            :: #force_inline proc(label: string, v: [3]f32, v_speed := f32(1.0), v_min := f32(0.0), v_max := f32(0.0), format := "%.3f", flags := Slider_Flags(0)) -> bool                               do return swr_igDragFloat3(label, v, v_speed, v_min, v_max, format, flags);
drag_float4                            :: #force_inline proc(label: string, v: [4]f32, v_speed := f32(1.0), v_min := f32(0.0), v_max := f32(0.0), format := "%.3f", flags := Slider_Flags(0)) -> bool                               do return swr_igDragFloat4(label, v, v_speed, v_min, v_max, format, flags);
...
drag_int2                              :: #force_inline proc(label: string, v: [2]i32, v_speed := f32(1.0), v_min := i32(0), v_max := i32(0), format := "%d", flags := Slider_Flags(0)) -> bool                                     do return swr_igDragInt2(label, v, v_speed, v_min, v_max, format, flags);
drag_int3                              :: #force_inline proc(label: string, v: [3]i32, v_speed := f32(1.0), v_min := i32(0), v_max := i32(0), format := "%d", flags := Slider_Flags(0)) -> bool                                     do return swr_igDragInt3(label, v, v_speed, v_min, v_max, format, flags);
drag_int4                              :: #force_inline proc(label: string, v: [4]i32, v_speed := f32(1.0), v_min := i32(0), v_max := i32(0), format := "%d", flags := Slider_Flags(0)) -> bool                                     do return swr_igDragInt4(label, v, v_speed, v_min, v_max, format, flags);
...
dummy                                  :: #force_inline proc(size: linalg.Vector2f32)                                                                                                                                                            do igDummy(size);
...
get_content_region_avail               :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetContentRegionAvail(pOut);
get_content_region_max                 :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetContentRegionMax(pOut);
get_current_context                    :: #force_inline proc() -> ^Context                                                                                                                                                          do return igGetCurrentContext();
get_cursor_pos                         :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetCursorPos(pOut);
...
get_cursor_screen_pos                  :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetCursorScreenPos(pOut);
get_cursor_start_pos                   :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetCursorStartPos(pOut);
...
get_font_tex_uv_white_pixel            :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetFontTexUvWhitePixel(pOut);
...
get_item_rect_max                      :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetItemRectMax(pOut);
get_item_rect_min                      :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetItemRectMin(pOut);
get_item_rect_size                     :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetItemRectSize(pOut);
...
get_mouse_drag_delta                   :: #force_inline proc(pOut: ^linalg.Vector2f32, button := Mouse_Button(0), lock_threshold := f32(-1.0))                                                                                                   do igGetMouseDragDelta(pOut, button, lock_threshold);
get_mouse_pos                          :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetMousePos(pOut);
get_mouse_pos_on_opening_current_popup :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetMousePosOnOpeningCurrentPopup(pOut);
...
get_window_content_region_max          :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetWindowContentRegionMax(pOut);
get_window_content_region_min          :: #force_inline proc(pOut: ^linalg.Vector2f32)                                                                                                                                                           do igGetWindowContentRegionMin(pOut);
...
get_window_pos                         :: #force_inline proc() -> linalg.Vector2f32                                                                                                                                                              do return wrapper_get_window_pos();
get_window_size                        :: #force_inline proc() -> linalg.Vector2f32                                                                                                                                                              do return wrapper_get_window_size();
get_window_width                       :: #force_inline proc() -> f32                                                                                                                                                               do return igGetWindowWidth();
image                                  :: #force_inline proc(user_texture_id: Texture_ID, size: linalg.Vector2f32, uv0 := linalg.Vector2f32(linalg.Vector2f32 {0,0}), uv1 := linalg.Vector2f32(linalg.Vector2f32 {1,1}), tint_col := Vec4(Vec4 {1,1,1,1}), border_col := Vec4(Vec4 {0,0,0,0}))       do igImage(user_texture_id, size, uv0, uv1, tint_col, border_col);
image_button                           :: #force_inline proc(user_texture_id: Texture_ID, size: linalg.Vector2f32, uv0 := linalg.Vector2f32(linalg.Vector2f32 {0,0}), uv1 := linalg.Vector2f32(linalg.Vector2f32 {1,1}), frame_padding := i32(-1), bg_col := Vec4(Vec4 {0,0,0,0}), tint_col := Vec4(Vec4 {1,1,1,1})) -> bool do return igImageButton(user_texture_id, size, uv0, uv1, frame_padding, bg_col, tint_col);
...
input_float2                           :: #force_inline proc(label: string, v: [2]f32, format := "%.3f", flags := Input_Text_Flags(0)) -> bool                                                                                      do return swr_igInputFloat2(label, v, format, flags);
input_float3                           :: #force_inline proc(label: string, v: [3]f32, format := "%.3f", flags := Input_Text_Flags(0)) -> bool                                                                                      do return swr_igInputFloat3(label, v, format, flags);
input_float4                           :: #force_inline proc(label: string, v: [4]f32, format := "%.3f", flags := Input_Text_Flags(0)) -> bool                                                                                      do return swr_igInputFloat4(label, v, format, flags);
...
input_int2                             :: #force_inline proc(label: string, v: [2]i32, flags := Input_Text_Flags(0)) -> bool                                                                                                        do return swr_igInputInt2(label, v, flags);
input_int3                             :: #force_inline proc(label: string, v: [3]i32, flags := Input_Text_Flags(0)) -> bool                                                                                                        do return swr_igInputInt3(label, v, flags);
input_int4                             :: #force_inline proc(label: string, v: [4]i32, flags := Input_Text_Flags(0)) -> bool                                                                                                        do return swr_igInputInt4(label, v, flags);
...
input_text_multiline                   :: #force_inline proc(label: string, buf: string, buf_size: uint, size := linalg.Vector2f32(linalg.Vector2f32 {0,0}), flags := Input_Text_Flags(0), callback : Input_Text_Callback = nil, user_data : rawptr = nil) -> bool do return swr_igInputTextMultiline(label, buf, buf_size, size, flags, callback, user_data);
...
invisible_button                       :: #force_inline proc(str_id: string, size: linalg.Vector2f32, flags := Button_Flags(0)) -> bool                                                                                                          do return swr_igInvisibleButton(str_id, size, flags);
...
is_mouse_hovering_rect                 :: #force_inline proc(r_min: linalg.Vector2f32, r_max: linalg.Vector2f32, clip := bool(true)) -> bool                                                                                                                  do return igIsMouseHoveringRect(r_min, r_max, clip);
is_mouse_pos_valid                     :: #force_inline proc(mouse_pos : ^linalg.Vector2f32 = nil) -> bool                                                                                                                                       do return igIsMousePosValid(mouse_pos);
...
is_rect_visible_nil                    :: #force_inline proc(size: linalg.Vector2f32) -> bool                                                                                                                                                    do return igIsRectVisible_Nil(size);
is_rect_visible_vec2                   :: #force_inline proc(rect_min: linalg.Vector2f32, rect_max: linalg.Vector2f32) -> bool                                                                                                                                do return igIsRectVisible_Vec2(rect_min, rect_max);
...
plot_histogram_float_ptr               :: #force_inline proc(label: string, values: ^f32, values_count: i32, values_offset := i32(0), overlay_text := "", scale_min := f32(max(f32)), scale_max := f32(max(f32)), graph_size := linalg.Vector2f32(linalg.Vector2f32 {0,0}), stride := i32(size_of(f32))) do swr_igPlotHistogram_FloatPtr(label, values, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size, stride);
plot_histogram_fn_float_ptr            :: #force_inline proc(label: string, values_getter: Value_Getter_Proc, data: rawptr, values_count: i32, values_offset: i32, overlay_text: string, scale_min: f32, scale_max: f32, graph_size: linalg.Vector2f32) do wrapper_plot_histogram_fn_float_ptr(label, values_getter, data, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size);
...
plot_lines_float_ptr                   :: #force_inline proc(label: string, values: ^f32, values_count: i32, values_offset := i32(0), overlay_text := "", scale_min := f32(max(f32)), scale_max := f32(max(f32)), graph_size := linalg.Vector2f32(linalg.Vector2f32 {0,0}), stride := i32(size_of(f32))) do swr_igPlotLines_FloatPtr(label, values, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size, stride);
plot_lines_fn_float_ptr                :: #force_inline proc(label: string, values_getter: Value_Getter_Proc, data: rawptr, values_count: i32, values_offset: i32, overlay_text: string, scale_min: f32, scale_max: f32, graph_size: linalg.Vector2f32) do wrapper_plot_lines_fn_float_ptr(label, values_getter, data, values_count, values_offset, overlay_text, scale_min, scale_max, graph_size);
...
progress_bar                           :: #force_inline proc(fraction: f32, size_arg := linalg.Vector2f32(linalg.Vector2f32 {-min(f32),0}), overlay := "")                                                                                                    do swr_igProgressBar(fraction, size_arg, overlay);
...
push_clip_rect                         :: #force_inline proc(clip_rect_min: linalg.Vector2f32, clip_rect_max: linalg.Vector2f32, intersect_with_current_clip_rect: bool)                                                                                      do igPushClipRect(clip_rect_min, clip_rect_max, intersect_with_current_clip_rect);
...
push_style_var_vec2                    :: #force_inline proc(idx: Style_Var, val: linalg.Vector2f32)                                                                                                                                             do igPushStyleVar_Vec2(idx, val);
...
selectable_bool                        :: #force_inline proc(label: string, selected := bool(false), flags := Selectable_Flags(0), size := linalg.Vector2f32(linalg.Vector2f32 {0,0})) -> bool                                                                do return swr_igSelectable_Bool(label, selected, flags, size);
selectable_bool_ptr                    :: #force_inline proc(label: string, p_selected: ^bool, flags := Selectable_Flags(0), size := linalg.Vector2f32(linalg.Vector2f32 {0,0})) -> bool                                                                      do return swr_igSelectable_BoolPtr(label, p_selected, flags, size);
...
set_cursor_pos                         :: #force_inline proc(local_pos: linalg.Vector2f32)                                                                                                                                                       do igSetCursorPos(local_pos);
...
set_cursor_screen_pos                  :: #force_inline proc(pos: linalg.Vector2f32)                                                                                                                                                             do igSetCursorScreenPos(pos);
...
set_next_window_content_size           :: #force_inline proc(size: linalg.Vector2f32)                                                                                                                                                            do igSetNextWindowContentSize(size);
set_next_window_focus                  :: #force_inline proc()                                                                                                                                                                      do igSetNextWindowFocus();
set_next_window_pos                    :: #force_inline proc(pos: linalg.Vector2f32, cond := Cond(0), pivot := linalg.Vector2f32(linalg.Vector2f32 {0,0}))                                                                                                                 do igSetNextWindowPos(pos, cond, pivot);
set_next_window_size                   :: #force_inline proc(size: linalg.Vector2f32, cond := Cond(0))                                                                                                                                           do igSetNextWindowSize(size, cond);
set_next_window_size_constraints       :: #force_inline proc(size_min: linalg.Vector2f32, size_max: linalg.Vector2f32, custom_callback : Size_Callback = nil, custom_callback_data : rawptr = nil)                                                            do igSetNextWindowSizeConstraints(size_min, size_max, custom_callback, custom_callback_data);
...
set_window_pos_vec2                    :: #force_inline proc(pos: linalg.Vector2f32, cond := Cond(0))                                                                                                                                            do igSetWindowPos_Vec2(pos, cond);
set_window_pos_str                     :: #force_inline proc(name: string, pos: linalg.Vector2f32, cond := Cond(0))                                                                                                                              do swr_igSetWindowPos_Str(name, pos, cond);
...
set_window_size_vec2                   :: #force_inline proc(size: linalg.Vector2f32, cond := Cond(0))                                                                                                                                           do igSetWindowSize_Vec2(size, cond);
set_window_size_str                    :: #force_inline proc(name: string, size: linalg.Vector2f32, cond := Cond(0))                                                                                                                             do swr_igSetWindowSize_Str(name, size, cond);
...
slider_float2                          :: #force_inline proc(label: string, v: [2]f32, v_min: f32, v_max: f32, format := "%.3f", flags := Slider_Flags(0)) -> bool                                                                  do return swr_igSliderFloat2(label, v, v_min, v_max, format, flags);
slider_float3                          :: #force_inline proc(label: string, v: [3]f32, v_min: f32, v_max: f32, format := "%.3f", flags := Slider_Flags(0)) -> bool                                                                  do return swr_igSliderFloat3(label, v, v_min, v_max, format, flags);
slider_float4                          :: #force_inline proc(label: string, v: [4]f32, v_min: f32, v_max: f32, format := "%.3f", flags := Slider_Flags(0)) -> bool                                                                  do return swr_igSliderFloat4(label, v, v_min, v_max, format, flags);
...
slider_int2                            :: #force_inline proc(label: string, v: [2]i32, v_min: i32, v_max: i32, format := "%d", flags := Slider_Flags(0)) -> bool                                                                    do return swr_igSliderInt2(label, v, v_min, v_max, format, flags);
slider_int3                            :: #force_inline proc(label: string, v: [3]i32, v_min: i32, v_max: i32, format := "%d", flags := Slider_Flags(0)) -> bool                                                                    do return swr_igSliderInt3(label, v, v_min, v_max, format, flags);
slider_int4                            :: #force_inline proc(label: string, v: [4]i32, v_min: i32, v_max: i32, format := "%d", flags := Slider_Flags(0)) -> bool                                                                    do return swr_igSliderInt4(label, v, v_min, v_max, format, flags);
...
v_slider_float                         :: #force_inline proc(label: string, size: linalg.Vector2f32, v: ^f32, v_min: f32, v_max: f32, format := "%.3f", flags := Slider_Flags(0)) -> bool                                                        do return swr_igVSliderFloat(label, size, v, v_min, v_max, format, flags);
v_slider_int                           :: #force_inline proc(label: string, size: linalg.Vector2f32, v: ^i32, v_min: i32, v_max: i32, format := "%d", flags := Slider_Flags(0)) -> bool                                                          do return swr_igVSliderInt(label, size, v, v_min, v_max, format, flags);
v_slider_scalar                        :: #force_inline proc(label: string, size: linalg.Vector2f32, data_type: Data_Type, p_data: rawptr, p_min: rawptr, p_max: rawptr, format := "", flags := Slider_Flags(0)) -> bool                         do return swr_igVSliderScalar(label, size, data_type, p_data, p_min, p_max, format, flags);
