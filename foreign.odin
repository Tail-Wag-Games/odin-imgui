...
foreign cimgui {
	...
	ImDrawData_ScaleClipRects    :: proc(self: ^Draw_Data, fb_scale: linalg.Vector2f32) ---;
	...
	ImDrawList_AddBezierCubic              :: proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, p4: linalg.Vector2f32, col: u32, thickness: f32, num_segments: i32) ---;
	ImDrawList_AddBezierQuadratic          :: proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, col: u32, thickness: f32, num_segments: i32) ---;
	ImDrawList_AddCallback                 :: proc(self: ^Draw_List, callback: Draw_Callback, callback_data: rawptr) ---;
	ImDrawList_AddCircle                   :: proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, col: u32, num_segments: i32, thickness: f32) ---;
	ImDrawList_AddCircleFilled             :: proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, col: u32, num_segments: i32) ---;
	ImDrawList_AddConvexPolyFilled         :: proc(self: ^Draw_List, points: ^linalg.Vector2f32, num_points: i32, col: u32) ---;
	ImDrawList_AddDrawCmd                  :: proc(self: ^Draw_List) ---;
	ImDrawList_AddImage                    :: proc(self: ^Draw_List, user_texture_id: Texture_ID, p_min: linalg.Vector2f32, p_max: linalg.Vector2f32, uv_min: linalg.Vector2f32, uv_max: linalg.Vector2f32, col: u32) ---;
	ImDrawList_AddImageQuad                :: proc(self: ^Draw_List, user_texture_id: Texture_ID, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, p4: linalg.Vector2f32, uv1: linalg.Vector2f32, uv2: linalg.Vector2f32, uv3: linalg.Vector2f32, uv4: linalg.Vector2f32, col: u32) ---;
	ImDrawList_AddImageRounded             :: proc(self: ^Draw_List, user_texture_id: Texture_ID, p_min: linalg.Vector2f32, p_max: linalg.Vector2f32, uv_min: linalg.Vector2f32, uv_max: linalg.Vector2f32, col: u32, rounding: f32, flags: Draw_Flags) ---;
	ImDrawList_AddLine                     :: proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, col: u32, thickness: f32) ---;
	ImDrawList_AddNgon                     :: proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, col: u32, num_segments: i32, thickness: f32) ---;
	ImDrawList_AddNgonFilled               :: proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, col: u32, num_segments: i32) ---;
	ImDrawList_AddPolyline                 :: proc(self: ^Draw_List, points: ^linalg.Vector2f32, num_points: i32, col: u32, flags: Draw_Flags, thickness: f32) ---;
	ImDrawList_AddQuad                     :: proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, p4: linalg.Vector2f32, col: u32, thickness: f32) ---;
	ImDrawList_AddQuadFilled               :: proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, p4: linalg.Vector2f32, col: u32) ---;
	ImDrawList_AddRect                     :: proc(self: ^Draw_List, p_min: linalg.Vector2f32, p_max: linalg.Vector2f32, col: u32, rounding: f32, flags: Draw_Flags, thickness: f32) ---;
	ImDrawList_AddRectFilled               :: proc(self: ^Draw_List, p_min: linalg.Vector2f32, p_max: linalg.Vector2f32, col: u32, rounding: f32, flags: Draw_Flags) ---;
	ImDrawList_AddRectFilledMultiColor     :: proc(self: ^Draw_List, p_min: linalg.Vector2f32, p_max: linalg.Vector2f32, col_upr_left: u32, col_upr_right: u32, col_bot_right: u32, col_bot_left: u32) ---;
	ImDrawList_AddText_Vec2                :: proc(self: ^Draw_List, pos: linalg.Vector2f32, col: u32, text_begin: cstring, text_end: cstring) ---;
	ImDrawList_AddText_FontPtr             :: proc(self: ^Draw_List, font: ^ImFont, font_size: f32, pos: linalg.Vector2f32, col: u32, text_begin: cstring, text_end: cstring, wrap_width: f32, cpu_fine_clip_rect: ^Vec4) ---;
	ImDrawList_AddTriangle                 :: proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, col: u32, thickness: f32) ---;
	ImDrawList_AddTriangleFilled           :: proc(self: ^Draw_List, p1: linalg.Vector2f32, p2: linalg.Vector2f32, p3: linalg.Vector2f32, col: u32) ---;
	...
	ImDrawList_GetClipRectMax              :: proc(pOut: ^linalg.Vector2f32, self: ^Draw_List) ---;
	ImDrawList_GetClipRectMin              :: proc(pOut: ^linalg.Vector2f32, self: ^Draw_List) ---;
	ImDrawList_PathArcTo                   :: proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, a_min: f32, a_max: f32, num_segments: i32) ---;
	ImDrawList_PathArcToFast               :: proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, a_min_of_12: i32, a_max_of_12: i32) ---;
	ImDrawList_PathBezierCubicCurveTo      :: proc(self: ^Draw_List, p2: linalg.Vector2f32, p3: linalg.Vector2f32, p4: linalg.Vector2f32, num_segments: i32) ---;
	ImDrawList_PathBezierQuadraticCurveTo  :: proc(self: ^Draw_List, p2: linalg.Vector2f32, p3: linalg.Vector2f32, num_segments: i32) ---;
	ImDrawList_PathClear                   :: proc(self: ^Draw_List) ---;
	ImDrawList_PathFillConvex              :: proc(self: ^Draw_List, col: u32) ---;
	ImDrawList_PathLineTo                  :: proc(self: ^Draw_List, pos: linalg.Vector2f32) ---;
	ImDrawList_PathLineToMergeDuplicate    :: proc(self: ^Draw_List, pos: linalg.Vector2f32) ---;
	ImDrawList_PathRect                    :: proc(self: ^Draw_List, rect_min: linalg.Vector2f32, rect_max: linalg.Vector2f32, rounding: f32, flags: Draw_Flags) ---;
	...
	ImDrawList_PrimQuadUV                  :: proc(self: ^Draw_List, a: linalg.Vector2f32, b: linalg.Vector2f32, c: linalg.Vector2f32, d: linalg.Vector2f32, uv_a: linalg.Vector2f32, uv_b: linalg.Vector2f32, uv_c: linalg.Vector2f32, uv_d: linalg.Vector2f32, col: u32) ---;
	ImDrawList_PrimRect                    :: proc(self: ^Draw_List, a: linalg.Vector2f32, b: linalg.Vector2f32, col: u32) ---;
	ImDrawList_PrimRectUV                  :: proc(self: ^Draw_List, a: linalg.Vector2f32, b: linalg.Vector2f32, uv_a: linalg.Vector2f32, uv_b: linalg.Vector2f32, col: u32) ---;
	...
	ImDrawList_PrimVtx                     :: proc(self: ^Draw_List, pos: linalg.Vector2f32, uv: linalg.Vector2f32, col: u32) ---;
	ImDrawList_PrimWriteIdx                :: proc(self: ^Draw_List, idx: Draw_Idx) ---;
	ImDrawList_PrimWriteVtx                :: proc(self: ^Draw_List, pos: linalg.Vector2f32, uv: linalg.Vector2f32, col: u32) ---;
	ImDrawList_PushClipRect                :: proc(self: ^Draw_List, clip_rect_min: linalg.Vector2f32, clip_rect_max: linalg.Vector2f32, intersect_with_current_clip_rect: bool) ---;
	...
	ImDrawList__PathArcToFastEx            :: proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, a_min_sample: i32, a_max_sample: i32, a_step: i32) ---;
	ImDrawList__PathArcToN                 :: proc(self: ^Draw_List, center: linalg.Vector2f32, radius: f32, a_min: f32, a_max: f32, num_segments: i32) ---;
	...
	ImFontAtlas_AddCustomRectFontGlyph                :: proc(self: ^Font_Atlas, font: ^ImFont, id: Wchar, width: i32, height: i32, advance_x: f32, offset: linalg.Vector2f32) -> i32 ---;
	...
	ImFontAtlas_CalcCustomRectUV                      :: proc(self: ^Font_Atlas, rect: ^Font_Atlas_Custom_Rect, out_uv_min: ^linalg.Vector2f32, out_uv_max: ^linalg.Vector2f32) ---;
	...
	ImFontAtlas_GetMouseCursorTexData                 :: proc(self: ^Font_Atlas, cursor: Mouse_Cursor, out_offset: ^linalg.Vector2f32, out_size: ^linalg.Vector2f32, out_uv_border: [2]linalg.Vector2f32, out_uv_fill: [2]linalg.Vector2f32) -> bool ---;
	...
	ImFont_CalcTextSizeA         :: proc(pOut: ^linalg.Vector2f32, self: ^ImFont, size: f32, max_width: f32, wrap_width: f32, text_begin: cstring, text_end: cstring, remaining: ^cstring) ---;
	...
	ImFont_RenderChar            :: proc(self: ^ImFont, draw_list: ^Draw_List, size: f32, pos: linalg.Vector2f32, col: u32, c: Wchar) ---;
	ImFont_RenderText            :: proc(self: ^ImFont, draw_list: ^Draw_List, size: f32, pos: linalg.Vector2f32, col: u32, clip_rect: Vec4, text_begin: cstring, text_end: cstring, wrap_width: f32, cpu_fine_clip: bool) ---;
	...
	ImGuiViewport_GetCenter     :: proc(pOut: ^linalg.Vector2f32, self: ^Viewport) ---;
	ImGuiViewport_GetWorkCenter :: proc(pOut: ^linalg.Vector2f32, self: ^Viewport) ---;
	...
	igBeginChild_Str                   :: proc(str_id: cstring, size: linalg.Vector2f32, border: bool, flags: Window_Flags) -> bool ---;
	igBeginChild_ID                    :: proc(id: ImID, size: linalg.Vector2f32, border: bool, flags: Window_Flags) -> bool ---;
	igBeginChildFrame                  :: proc(id: ImID, size: linalg.Vector2f32, flags: Window_Flags) -> bool ---;
	...
	igBeginGroup                       :: proc() ---;
	igBeginListBox                     :: proc(label: cstring, size: linalg.Vector2f32) -> bool ---;
	...
	igBeginTable                       :: proc(str_id: cstring, column: i32, flags: Table_Flags, outer_size: linalg.Vector2f32, inner_width: f32) -> bool ---;
	igBeginTooltip                     :: proc() ---;
	igBullet                           :: proc() ---;
	igBulletText                       :: proc(fmt_: cstring, #c_vararg args: ..any) ---;
	igButton                           :: proc(label: cstring, size: linalg.Vector2f32) -> bool ---;
	...
	igCalcTextSize                     :: proc(pOut: ^linalg.Vector2f32, text: cstring, text_end: cstring, hide_text_after_double_hash: bool, wrap_width: f32) ---;
	...
	igColorButton                      :: proc(desc_id: cstring, col: Vec4, flags: Color_Edit_Flags, size: linalg.Vector2f32) -> bool ---;
	...
	igDummy                            :: proc(size: linalg.Vector2f32) ---;
	igEnd                              :: proc() ---;
	igEndChild                         :: proc() ---;
	...
	igGetContentRegionAvail            :: proc(pOut: ^linalg.Vector2f32) ---;
	igGetContentRegionMax              :: proc(pOut: ^linalg.Vector2f32) ---;
	igGetCurrentContext                :: proc() -> ^Context ---;
	igGetCursorPos                     :: proc(pOut: ^linalg.Vector2f32) ---;
	igGetCursorPosX                    :: proc() -> f32 ---;
	igGetCursorPosY                    :: proc() -> f32 ---;
	igGetCursorScreenPos               :: proc(pOut: ^linalg.Vector2f32) ---;
	igGetCursorStartPos                :: proc(pOut: ^linalg.Vector2f32) ---;
	...
	igGetFontTexUvWhitePixel           :: proc(pOut: ^linalg.Vector2f32) ---;
	...
	igGetIO                            :: proc() -> ^IO ---;
	igGetItemRectMax                   :: proc(pOut: ^linalg.Vector2f32) ---;
	igGetItemRectMin                   :: proc(pOut: ^linalg.Vector2f32) ---;
	igGetItemRectSize                  :: proc(pOut: ^linalg.Vector2f32) ---;
	...
	igGetMouseDragDelta                :: proc(pOut: ^linalg.Vector2f32, button: Mouse_Button, lock_threshold: f32) ---;
	igGetMousePos                      :: proc(pOut: ^linalg.Vector2f32) ---;
	igGetMousePosOnOpeningCurrentPopup :: proc(pOut: ^linalg.Vector2f32) ---;
	...
	igGetWindowContentRegionMax        :: proc(pOut: ^linalg.Vector2f32) ---;
	igGetWindowContentRegionMin        :: proc(pOut: ^linalg.Vector2f32) ---;
	igGetWindowContentRegionWidth      :: proc() -> f32 ---;
	igGetWindowDrawList                :: proc() -> ^Draw_List ---;
	igGetWindowHeight                  :: proc() -> f32 ---;
	igGetWindowPos                     :: proc(pOut: ^linalg.Vector2f32) ---;
	igGetWindowSize                    :: proc(pOut: ^linalg.Vector2f32) ---;
	igGetWindowWidth                   :: proc() -> f32 ---;
	igImage                            :: proc(user_texture_id: Texture_ID, size: linalg.Vector2f32, uv0: linalg.Vector2f32, uv1: linalg.Vector2f32, tint_col: Vec4, border_col: Vec4) ---;
	igImageButton                      :: proc(user_texture_id: Texture_ID, size: linalg.Vector2f32, uv0: linalg.Vector2f32, uv1: linalg.Vector2f32, frame_padding: i32, bg_col: Vec4, tint_col: Vec4) -> bool ---;
	...
	igInputTextMultiline               :: proc(label: cstring, buf: cstring, buf_size: uint, size: linalg.Vector2f32, flags: Input_Text_Flags, callback: Input_Text_Callback, user_data: rawptr) -> bool ---;
	...
	igInvisibleButton                  :: proc(str_id: cstring, size: linalg.Vector2f32, flags: Button_Flags) -> bool ---;
	...
	igIsMouseHoveringRect              :: proc(r_min: linalg.Vector2f32, r_max: linalg.Vector2f32, clip: bool) -> bool ---;
	igIsMousePosValid                  :: proc(mouse_pos: ^linalg.Vector2f32) -> bool ---;
	igIsMouseReleased                  :: proc(button: Mouse_Button) -> bool ---;
	igIsPopupOpen_Str                  :: proc(str_id: cstring, flags: Popup_Flags) -> bool ---;
	igIsRectVisible_Nil                :: proc(size: linalg.Vector2f32) -> bool ---;
	igIsRectVisible_Vec2               :: proc(rect_min: linalg.Vector2f32, rect_max: linalg.Vector2f32) -> bool ---;
	...
	igPlotHistogram_FloatPtr           :: proc(label: cstring, values: ^f32, values_count: i32, values_offset: i32, overlay_text: cstring, scale_min: f32, scale_max: f32, graph_size: linalg.Vector2f32, stride: i32) ---;
	igPlotHistogram_FnFloatPtr         :: proc(label: cstring, values_getter: Value_Getter_Proc, data: rawptr, values_count: i32, values_offset: i32, overlay_text: cstring, scale_min: f32, scale_max: f32, graph_size: linalg.Vector2f32) ---
	igPlotLines_FloatPtr               :: proc(label: cstring, values: ^f32, values_count: i32, values_offset: i32, overlay_text: cstring, scale_min: f32, scale_max: f32, graph_size: linalg.Vector2f32, stride: i32) ---;
	igPlotLines_FnFloatPtr             :: proc(label: cstring, values_getter: Value_Getter_Proc, data: rawptr, values_count: i32, values_offset: i32, overlay_text: cstring, scale_min: f32, scale_max: f32, graph_size: linalg.Vector2f32) ---
	...
	igProgressBar                      :: proc(fraction: f32, size_arg: linalg.Vector2f32, overlay: cstring) ---;
	igPushAllowKeyboardFocus           :: proc(allow_keyboard_focus: bool) ---;
	igPushButtonRepeat                 :: proc(repeat: bool) ---;
	igPushClipRect                     :: proc(clip_rect_min: linalg.Vector2f32, clip_rect_max: linalg.Vector2f32, intersect_with_current_clip_rect: bool) ---;
	...
	igPushStyleVar_Vec2                :: proc(idx: Style_Var, val: linalg.Vector2f32) ---;
	...
	igSelectable_Bool                  :: proc(label: cstring, selected: bool, flags: Selectable_Flags, size: linalg.Vector2f32) -> bool ---;
	igSelectable_BoolPtr               :: proc(label: cstring, p_selected: ^bool, flags: Selectable_Flags, size: linalg.Vector2f32) -> bool ---;
	igSeparator                        :: proc() ---;
	...
	igSetCursorPos                     :: proc(local_pos: linalg.Vector2f32) ---;
	igSetCursorPosX                    :: proc(local_x: f32) ---;
	igSetCursorPosY                    :: proc(local_y: f32) ---;
	igSetCursorScreenPos               :: proc(pos: linalg.Vector2f32) ---;
	...
	igSetNextWindowContentSize         :: proc(size: linalg.Vector2f32) ---;
	igSetNextWindowFocus               :: proc() ---;
	igSetNextWindowPos                 :: proc(pos: linalg.Vector2f32, cond: Cond, pivot: linalg.Vector2f32) ---;
	igSetNextWindowSize                :: proc(size: linalg.Vector2f32, cond: Cond) ---;
	igSetNextWindowSizeConstraints     :: proc(size_min: linalg.Vector2f32, size_max: linalg.Vector2f32, custom_callback: Size_Callback, custom_callback_data: rawptr) ---;
	...
	igSetWindowPos_Vec2                :: proc(pos: linalg.Vector2f32, cond: Cond) ---;
	igSetWindowPos_Str                 :: proc(name: cstring, pos: linalg.Vector2f32, cond: Cond) ---;
	igSetWindowSize_Vec2               :: proc(size: linalg.Vector2f32, cond: Cond) ---;
	igSetWindowSize_Str                :: proc(name: cstring, size: linalg.Vector2f32, cond: Cond) ---;
	...
	igVSliderFloat                     :: proc(label: cstring, size: linalg.Vector2f32, v: ^f32, v_min: f32, v_max: f32, format: cstring, flags: Slider_Flags) -> bool ---;
	igVSliderInt                       :: proc(label: cstring, size: linalg.Vector2f32, v: ^i32, v_min: i32, v_max: i32, format: cstring, flags: Slider_Flags) -> bool ---;
	igVSliderScalar                    :: proc(label: cstring, size: linalg.Vector2f32, data_type: Data_Type, p_data: rawptr, p_min: rawptr, p_max: rawptr, format: cstring, flags: Slider_Flags) -> bool ---;
